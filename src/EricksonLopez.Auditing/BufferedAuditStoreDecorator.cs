...
public sealed partial class BufferedAuditStoreDecorator : IAuditStore, IAsyncDisposable, IDisposable
{
    ...
    private async Task ProcessQueueAsync()
    {
        ...
        {
            await DrainRemainingOnShutdownAsync(reader, batch).ConfigureAwait(false);
        }
    }
    ...
    private async Task DrainRemainingOnShutdownAsync(System.Threading.Channels.ChannelReader<AuditRecord> reader, List<AuditRecord> batch)
    {
