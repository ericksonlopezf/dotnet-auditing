...
public sealed partial class BufferedAuditStoreDecorator : IAuditStore, IAsyncDisposable, IDisposable
{
    ...
    // Stryker disable once all : Infrastructure resilience configuration
        ...
        ILogger<BufferedAuditStoreDecorator>? logger = null)
    {
        ...
        // Stryker disable once all : Channel internal concurrency and backpressure hints do not alter observable batching behavior
    ...
    private async Task ProcessQueueAsync()
    {
        ...
        {
            // Stryker disable once all : Defensive diagnostic logging for unexpected worker crash
    ...
    // Stryker disable once all : Polling loop condition causes infinite busy-loop timeouts under mutation
    ...
    // Stryker disable once all : Fast-path single-tenant optimization is functionally equivalent to dictionary partitioning
