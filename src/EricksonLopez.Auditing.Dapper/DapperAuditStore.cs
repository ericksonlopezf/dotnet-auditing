...
public sealed class DapperAuditStore : IAuditStore
{
    ...
    /// <inheritdoc/>
    [SuppressMessage("Security", "S2077:Use a parameterized query instead of string formatting.", Justification = "Table name is a sanitized configuration identifier that cannot be parameterized in SQL.")]
