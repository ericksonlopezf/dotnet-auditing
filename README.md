...
* **Mutation Testing (Stryker.NET):** **≥ 99.0%** Mutation Score (1,400+ mutants killed across 12 packages)
...
Distributed under the [**MIT License**](https://github.com/ericksonlopezf/dotnet-auditing/blob/main/LICENSE). Copyright © 2026 Erickson Lopez.
